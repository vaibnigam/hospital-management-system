        ...
        while (running) {
            ...
            switch (choice) {
                ...
                case 1:
                    ...
                    Patient newPatient = patientService.addPatient(name, contactNumber, age, diseaseInfo, assignedDoctorId, bloodGroup);
                    System.out.println(newPatient != null ? "Patient added! ID: " + newPatient.getId() : "Failed to add patient. Check inputs.");
                    break;
                ...
                case 2:
                    ...
                    Doctor newDoctor = doctorService.addDoctor(doctorName, doctorContact, doctorAge, specialization, consultationFee, experienceYears);
                    System.out.println(newDoctor != null ? "Doctor added! ID: " + newDoctor.getId() : "Failed to add doctor. Check inputs.");
                    break;
                ...
                case 3:
                    ...
                    try {
                        ...
                        System.out.println(newNurse != null ? "Nurse added! ID: " + newNurse.getId() : "Failed to add nurse. Check inputs.");
                ...
                case 4:
                    ...
                    try {
                        ...
                        System.out.println(newAdmin != null ? "Admin added! ID: " + newAdmin.getId() : "Failed to add admin. Check inputs.");
                    } catch (IllegalArgumentException e) {
                ...
                case 14:
                    ...
                    try {
                        ...
                        System.out.println(appointment != null ? "Appointment scheduled! ID: " + appointment.getAppointmentId() : "Scheduling failed.");
                    } catch (Exception e) {
                ...
                case 15:
                    ...
                    System.out.println(completed ? "Appointment completed successfully." : "Failed to complete appointment.");
                    break;
                ...
                case 17:
                    ...
                    List<Appointment> patientAppointments = appointmentService.getAppointmentsByPatient(appointmentPatientId);
                ...
                case 20:
                    ...
                    System.out.println(reassigned ? "Doctor reassigned successfully." : "Reassignment failed. Check patient/doctor IDs.");
                    break;
                ...
                case 21:
                    ...
                    System.out.println(billing != null ? "Bill generated! Bill ID: " + billing.getBillId() : "Failed to generate bill.");
                    break;
